...
### 🚗 [Car Rental Management System](https://github.com/sharky83/CarRental)
A full-stack web application for managing car rentals with separate interfaces for customers and car owners.
- **Tech**: React, Node.js, MongoDB, Express
- **Features**: User authentication, booking management, owner dashboard

### 🌐 [Next.js Web Applications]
Modern, server-side rendered applications built with Next.js and PostgreSQL.
- **Tech**: Next.js, PostgreSQL, React
- **Features**: SSR/SSG, API routes, database integration
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=sharky83&color=blueviolet&style=flat-square&label=Profile+Views" alt="Profile Views" />
</div>

⭐️ From [sharky83](https://github.com/sharky83)
